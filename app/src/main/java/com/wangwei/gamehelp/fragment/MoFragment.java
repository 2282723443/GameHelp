 ...
 */
public class MoFragment extends ItemClickLister {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_mo, container, false);
    ...
    private void refresh() {
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                Log.v("tedu", "我是线程运行的：");
                HttpUtil.testVolleymo(new Response.Listener<String>() {
                    @Override
                    public void onResponse(String s) {
                        Log.v("tedu", "魔兽界面生成的网络请求地址是："+s);
                        Gson gson = new Gson();

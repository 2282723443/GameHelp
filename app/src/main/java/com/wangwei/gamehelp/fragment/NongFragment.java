 ...
 */
public class NongFragment extends ItemClickLister {
    ...
    private void refresh() {
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                Log.v("tedu", "我是线程运行的：");
                HttpUtil.testVolleynong(new Response.Listener<String>() {
                    @Override
                    public void onResponse(String s) {
                        Log.v("tedu", "王者荣耀界面生成的网络请求地址是："+s);
                        Gson gson = new Gson();
